...
export function BottleBody({ meshes, innerOneVariant = "black" }: MeshComponentProps) {
  ...
  const glassProps = useControls(
    "MYO Glass Transmission",
    {
      ...
      resolution: { value: MYO_GLASS.resolution, min: 256, max: 4096, step: 256, label: "Resolution" },
      ...
      transmission: { value: MYO_GLASS.transmission, min: 0, max: 1, step: 0.01, label: "Transmission" },
      clearcoat: { value: MYO_GLASS.clearcoat, min: 0, max: 1, step: 0.01, label: "Clearcoat" },
      clearcoatRoughness: {
        value: MYO_GLASS.clearcoatRoughness,
        min: 0,
        max: 1,
        step: 0.01,
      ...
      envMapIntensity: {
        value: MYO_GLASS.envMapIntensity,
        min: 0,
        max: 5,
        step: 0.05,
